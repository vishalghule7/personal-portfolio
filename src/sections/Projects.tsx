  ...
  return (
    <section className="pb-16 lg:py-24"> 
        <div className=" container">
          ...
          <p className=" text-center font-semibold uppercase tracking-widest bg-gradient-to-r from-emerald-400 to to-sky-400 bg-clip-text text-transparent">Projects-Section</p>
          </div>
          <h2 className="font-serif text-3xl md:text-5xl text-center mt-6">Featured Projects</h2>
          <p className=" text-center text-white/60 md:text-lg lg:text-xl max-w-md mx-auto mt-4">I transformed concepts into engaging digital experience.</p>
          <div className="flex flex-col mt-10 md:mt-20 gap-16">
            {portfolioProjects.map((project) => (
              <div key={project.title} className="bg-gray-800 px-8 pt-8 md:px-12 md:pt-10 lg:pt-14 lg:px-16 rounded-3xl z-0 relative overflow-hidden after:z-10 border-2 border-white/20   " >
                ...
                <h3 className=" font-serif text-xl md:text-4xl tracking-wid mt-2 md:mt-5">{project.title}</h3>
